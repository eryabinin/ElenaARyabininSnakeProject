...
public class Snake {
	...
	protected void createStartSnake(){
		...
		snakeSize = 3;//initial snake size = 3 squares
	...
	public void snakeDown(){
            ...
            // coordinated the move of the snake depends on the key
...
//	}
	...
	public boolean didEatSpider(Spider spider) {
        //Is this spider in the snake? It should be in the same square as the snake's head
        if (spider.getSpiderX() == snakeHeadX && spider.getSpiderY() == snakeHeadY){
			justAteMustGrowThisMuch += growthIncrement * 2;
            return true;
        }
        return false;
    }
	...
	public boolean wonGame() {
		...
		//If all of the squares have snake segments in, the snake has eaten so much kibble and spider
